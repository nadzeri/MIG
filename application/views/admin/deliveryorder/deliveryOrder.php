                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h2 class="modal-title" id="myModalLabel">Daftar Cabang</h2>
                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><input type="radio" name="ID_Cabang" value="<?php echo $cab->ID_Cabang;?>"><button type="button" class="btn btn-info btn-circle"><i class="fa fa-check"></i></button></td>
                                                        <td><?php echo $cab->Bank;?></td>
                                                        <td><?php echo $cab->Nama_Cabang;?></td>
                                                        <td><?php echo $cab->Alamat;?></td>
                                                        <td><?php echo $cab->Kota;?></td>
                                                        <td><?php echo $cab->Provinsi;?></td>
                                                    </tr>
                                                    <?php }?>
                                                    </form>                                            
                                                </tbody>
